...
write.csv(results_table[,c("x", "y", "class")], file = "/Users/brendan/Desktop/PostDoc/work/HuBMAP/repos/multiscale_celltype_colocalization_analysis/data/slide_seq/slideseq.puck190926_08.rctd.meta.csv", sep = ",")
...
write.csv(x = results_table_filt, file = "/Users/brendan/Desktop/PostDoc/work/HuBMAP/repos/multiscale_celltype_colocalization_analysis/data/temp/slideseqPuck.190926_08.rctd.meta.csv", row.names = TRUE, sep=",")
...
rctd_subsets100 <- readRDS("/Users/brendan/Desktop/PostDoc/work/HuBMAP/repos/multiscale_celltype_colocalization_analysis/data/slide_seq/slideseqPuck.190926_08.rctd.subsets.near.subdist100.rds")
rctd_subsets200 <- readRDS("/Users/brendan/Desktop/PostDoc/work/HuBMAP/repos/multiscale_celltype_colocalization_analysis/data/slide_seq/slideseqPuck.190926_08.rctd.subsets.near.subdist200.rds")
...
annots_temp <- getSubsetComs(com = com,
                             pos = pos,
                             subset_list = rctd_subsets100,
                             neighIDs = c("Bergmann", "Purkinje"),
                             subsetIDs = c("Purkinje_near_Purkinje"))
...
dat <- dat[dat$dist %in% c("50", "100", "200", "300"),]
dat <- dat[dat$resolution %in% c(50,100,200,300,500,700,800,1000,1200,1500,3000),]

plotTrends(results = dat, idcol = "dist", figPath = paste0(figpath, "slideseqPuck.190926_08.rctd.pairwise.pdf"),
          width = 35, height = 35)
...
dat <- dat[dat$resolution %in% c(100,200,300,400,500,600,700,800,1000,1500,3000),]

dat <- dat[grepl(pattern = "Granule_near_", x = dat$reference),]

plotTrendsOverlay(results = dat, idcol = "dist", figPath = paste0(figpath, "slideseqPuck.190926_08_dist100_subDist100.subsets.gran.overlay.pdf"),
          width = 3, height = 30)
