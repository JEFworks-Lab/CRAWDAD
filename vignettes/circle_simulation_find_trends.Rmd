...
pos_1circle_results <- lapply(distances, function(d){
  ...
  if(file.exists(shuffledData)){
    ...
    pos <- circle_pos[circle_pos$id == "90",]
    results_circsiz90 <- findTrendsv2(pos = pos[,c("x", "y")],
                               celltypes = pos$type,
                               resolutions,
                               dist = d,
                               perms = prms,
  ...
  if(file.exists(shuffledData)){
    ...
    pos <- circle_pos[circle_pos$id == "150",]
    results_circsiz150 <- findTrendsv2(pos = pos[,c("x", "y")],
                               celltypes = pos$type,
                               resolutions,
                               dist = d,
                               perms = prms,
  ...
  if(file.exists(shuffledData)){
    ...
    pos <- circle_pos[circle_pos$id == "300",]
    results_circsiz300 <- findTrendsv2(pos = pos[,c("x", "y")],
                               celltypes = pos$type,
                               resolutions,
                               dist = d,
                               perms = prms,
  ...
  if(file.exists(shuffledData)){
    ...
    pos <- circle_pos[circle_pos$id == "400",]
    results_circsiz400 <- findTrendsv2(pos = pos[,c("x", "y")],
                               celltypes = pos$type,
                               resolutions,
                               dist = d,
                               perms = prms,
