...
ggplot2::ggsave(filename = "S4_slideseq_berg_ripleys.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
dat <- results.melt.berg
dat <- dat[!dat$celltypes %in% c(ignore),]

plt <- ggplot2::ggplot(data = dat) +
  ggplot2::geom_line(ggplot2::aes(x = r, y = K, color = celltypes)) +
  ggplot2::facet_wrap(~celltypes) +
  ggplot2::theme_classic() +
  ggplot2::theme(axis.text.x = ggplot2::element_text(size=12, color = "black", angle = -90, vjust = 0.5, hjust = 0),
                   axis.text.y = ggplot2::element_text(size=12, color = "black"),
                   axis.title.y = ggplot2::element_text(size=15),
...
ggplot2::ggsave(filename = "S4_slideseq_berg_ripleys_facet.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S4_slideseq_purk_ripleys_facet.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S4_slideseq_mli1_ripleys_facet.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S4_slideseq_mli2_ripleys_facet.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S5_seqfish_intMeso_ripleys_facet.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S5_seqfish_endo_ripleys_endo_facet.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S5_seqfish_latplate_ripleys_facet.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S5_seqfish_haem_ripleys_facet.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S5_seqfish_merge_ripleys.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
