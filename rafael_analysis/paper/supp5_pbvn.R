...
sort(table(pbvn$celltypes))
set.seed(8) 
cols <- sample(rainbow(length(unique(pbvn$celltypes))))
names(cols) <- unique(pbvn$celltypes)
cols['indistinct'] <- 'grey'

table(pbvn$celltypes)
vi <- pbvn$celltypes %in% c('Podoplanin', 'CD4 Memory T cells', 'Fol B cells')
ggplot(pbvn, aes(x=x, y=y, col=celltypes)) + geom_point(size=0.2, alpha=0.5) + theme_void() +
...
# results <- readRDS("/Users/jeanfan/Downloads/pbvn.pairwise.100-200.folBcombined.results.res100-6000.removeDups.rds")
...
save(results, shuffle.list, file="rafael_analysis/paper/supp5_pbvn.RData")
...
# vizAllClusters(cells, pbvn$celltypes)
...
saveRDS(binomMat, file="rafael_analysis/paper/supp5_pbvn_binomMat.RDS")
binomMat <- readRDS("rafael_analysis/paper/supp5_pbvn_binomMat.RDS")
...
saveRDS(subset.list, file="rafael_analysis/paper/supp5_pbvn_subset.RDS")
subset.list <- readRDS("rafael_analysis/paper/supp5_pbvn_subset.RDS")
...
## 8.0865 hours to run
results.subsets
saveRDS(results.subsets, file="rafael_analysis/paper/supp5_pbvn_results.subsets.RDS")
results.subsets <- readRDS("rafael_analysis/paper/supp5_pbvn_results.subsets.RDS")
...
p
pdf('rafael_analysis/paper/pbvn_CD4folB_podo.pdf')
p 
dev.off()
...
p <- vizTrends(d1, lines = T, withPerms = T, sig.thresh = zsigs)
p
pdf('rafael_analysis/paper/pbvn_podofolB_CD4.pdf')
p 
dev.off()
...
annots_temp <- crawdad::selectLabels(df = pbvn,
                                     com = pbvn$celltypes,
...
p
pdf('rafael_analysis/paper/supp5_pbvn_follB_trend.pdf')
p 
dev.off()
...
p <- vizTrends(dat_filter, lines = T, withPerms = T, sig.thresh = zsigs)
p
pdf('rafael_analysis/paper/supp5_pbvn_redpulb_trend.pdf')
p 
dev.off()
...
p <- vizColocDotplot(dat_filtered, reorder = TRUE, zsig.thresh = zsig, zscore.limit = zsig*2) + 
  ...
  theme(legend.position='bottom',
        ...
        legend.box = 'vertical')
p
pdf('rafael_analysis/paper/supp5c_pbvn.pdf', height = 7.7, width = 6.05)
p 
dev.off()
...
p <- vizColocDotplot(dat_filtered, reorder = TRUE, zsig.thresh = zsig, zscore.limit = zsig*2) + 
  ...
  theme(legend.position='bottom',
        ...
        legend.box = 'vertical')
p
pdf('rafael_analysis/paper/supp5c_pbvn_ordered_pkhl.pdf', height = 7.7, width = 6.05)
p 
dev.off()
...
p
png('rafael_analysis/paper/supp5_pbvn_spat_cts.png', height = 1024, width = 1024)
p 
dev.off()
...
p <- vizTrends(dat_filter, lines = T, withPerms = T, sig.thresh = zsigs)
p
pdf('rafael_analysis/paper/replication/pbvn_podofolB_CD4.pdf')
p 
dev.off()
...
p <- vizTrends(dat_filter, lines = T, withPerms = T, sig.thresh = zsigs)
p
pdf('rafael_analysis/paper/replication/pbvn_podoredpulp_CD4.pdf')
p 
dev.off()
...
p <- ggplot() + 
  ...
  theme(legend.position="none")
p
png('rafael_analysis/paper/subsets/podo_pbvn_spat_cts.png', height = 1024, width = 1024)
p 
dev.off()
...
saveRDS(binomMat, file="rafael_analysis/paper/supp5_pbvn_binomMat500.RDS")
...
saveRDS(subset.list, file="rafael_analysis/paper/supp5_pbvn_subset500.RDS")
...
## 8.0865 hours to run
results.subsets
saveRDS(results.subsets, file="rafael_analysis/paper/supp5_pbvn_results500.subsets.RDS")
results.subsets <- readRDS("rafael_analysis/paper/supp5_pbvn_results500.subsets.RDS")
...
p <- ggplot() + 
  ...
  theme(legend.position="none")
p
png('rafael_analysis/paper/subsets2/pbvn_spat_cts_cd4folb2.png', height = 1024, width = 1024)
p 
dev.off()
...
p <- ggplot() + 
  ...
  theme(legend.position="none")
p
png('rafael_analysis/paper/subsets500/podo_pbvn_spat_cts_500.png', height = 1024, width = 1024)
p 
dev.off()
...
results.subsets <- crawdad::findTrends(cells,
                                       ...
                                       returnMeans = FALSE)
## 8.0865 hours to run
saveRDS(results.subsets, file="rafael_analysis/paper/supp5_pbvn_podo_results500.subsets.RDS")
results.subsets <- readRDS("rafael_analysis/paper/supp5_pbvn_podo_results500.subsets.RDS")
...
p <- vizTrends(dat_filter, lines = T, withPerms = T, sig.thresh = zsigs)
p
pdf('rafael_analysis/paper/subsets500/pbvn_podo_near_folB_CD4.pdf')
p 
dev.off()
...
p <- vizTrends(dat_filter, lines = T, withPerms = T, sig.thresh = zsigs)
p
pdf('rafael_analysis/paper/subsets500/pbvn_podo_not_near_folB_CD4.pdf')
p 
dev.off()
