...
Load data.frame of cell positions and labels and convert it to an `sp::SpatialPointsDataFrame` object. This is because CRAWDAD builds upon the `sf` library in R.
