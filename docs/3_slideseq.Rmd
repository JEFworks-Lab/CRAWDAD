...
## example: neighbor cell types that are significantly separated with Purkinje at some scale
...
## example: neighbor cell types that become significantly co-localized and separated at difference scales with Purkinje
