...
ggplot2::ggsave(filename = "4A_pkhl_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
annots_temp <- crawdad::selectLabels(df = pkhl,
                                     ...
                                     cellIDs = c("CD4 Memory T cells", "Neutrophils/Monocytes"),
...
ggplot2::ggsave(filename = "4A_pkhl_cd4_near_neutro_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
plt <- crawdad::vizAllClusters(cells = pkhl,
                        coms = as.factor(pkhl$celltypes),
                        ofInterest = c("CD4 Memory T cells", "Neutrophils/Monocytes"),
                        s = 2) +
  ggplot2::theme(legend.position="none")
  # ggplot2::guides(colour = ggplot2::guide_legend(override.aes = list(size=2), ncol = 1))

ggplot2::ggsave(filename = "4A_pkhl_cd4_neutro_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4A_pkhl_grid_38_39_tissue_zoom.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4A_pkhl_grid_66_77_tissue_zoom.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
#### Fig 4 - cd4,folB,podo trends

```{r}

dat <- crawdad::meltResultsList(results.pkhl, id = "dist100")

grDevices::pdf(file = paste0(figpath, "/4B_cd4_trends.pdf"), width = 6, height = 4)
d <- dat[dat$reference == "CD4 Memory T cells" & dat$neighbor %in% c("CD4 Memory T cells", "Fol B cells", "Podoplanin"),]
crawdad::plotTrendsOverlay(results = d)
dev.off()

grDevices::pdf(file = paste0(figpath, "/4B_folB_trends.pdf"), width = 6, height = 4)
d <- dat[dat$reference == "Fol B cells" & dat$neighbor %in% c("CD4 Memory T cells", "Fol B cells", "Podoplanin"),]
crawdad::plotTrendsOverlay(results = d)
dev.off()

grDevices::pdf(file = paste0(figpath, "/4B_podo_trends.pdf"), width = 6, height = 4)
d <- dat[dat$reference == "Podoplanin" & dat$neighbor %in% c("CD4 Memory T cells", "Fol B cells", "Podoplanin"),]
crawdad::plotTrendsOverlay(results = d)
dev.off()
...
d1$id <- "CD4 Memory T cells vs Fol B cells"
d2$id <- "CD4 Memory T cells vs Podoplanin"
...
ggplot2::ggsave(filename = "4B_pkhl_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
dat <- crawdad::meltResultsList(results.subsets.pkhl, id = "dist100")

grDevices::pdf(file = paste0(figpath, "/4B_podo_subsets_trends.pdf"), width = 4, height = 24)
d <- dat[grepl(pattern = "Podoplanin_near_", dat$reference) & dat$neighbor %in% c("CD4 Memory T cells", "Fol B cells", "Podoplanin"),]
crawdad::plotTrendsOverlay(results = d)
dev.off()

grDevices::pdf(file = paste0(figpath, "/4B_cd4_subsets_trends.pdf"), width = 4, height = 24)
d <- dat[grepl(pattern = "CD4 Memory T cells_near_", dat$reference) & dat$neighbor %in% c("CD4 Memory T cells", "Fol B cells", "Podoplanin"),]
crawdad::plotTrendsOverlay(results = d)
dev.off()

grDevices::pdf(file = paste0(figpath, "/4B_folB_subsets_trends.pdf"), width = 4, height = 24)
d <- dat[grepl(pattern = "Fol B cells_near_", dat$reference) & dat$neighbor %in% c("CD4 Memory T cells", "Fol B cells", "Podoplanin"),]
crawdad::plotTrendsOverlay(results = d)
dev.off()
...
d <- dat[grepl(pattern = "CD4 Memory T cells_near_Fol B cells", dat$reference) & dat$neighbor %in% c("CD4 Memory T cells", "Fol B cells", "Podoplanin"),]
plt <- vizTrends(dat = d, facet = FALSE, id = "neighbor", title = "CD4 Memory T cells near Fol B cells") +
  ggplot2::scale_x_log10()
  # ggplot2::theme(legend.position="none")
plt

ggplot2::ggsave(filename = "4B_cd4_near_folB_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
d <- dat[grepl(pattern = "CD4 Memory T cells_near_Neutrophils/Monocytes", dat$reference) & dat$neighbor %in% c("CD4 Memory T cells", "Fol B cells", "Podoplanin"),]
plt <- vizTrends(dat = d, facet = FALSE, id = "neighbor", title = "CD4 Memory T cells near Neutrophils/Monocytes") +
  ggplot2::scale_x_log10()
  # ggplot2::theme(legend.position="none")
plt

ggplot2::ggsave(filename = "4B_cd4_near_neutro_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4A_ksfb_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4A_xxcd_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4A_pbvn_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4A_fsld_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4A_ngpl_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_ksfb_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_xxcd_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_pbvn_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_fsld_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_ngpl_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_folB_trends_ksfb.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_neutro_trends_ksfb.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_folB_trends_xxcd.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_neutro_trends_xxcd.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_folB_trends_pbvn.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_neutro_trends_pbvn.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_folB_trends_fsld.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_neutro_trends_fsld.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_folB_trends_ngpl.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "4B_cd4_near_neutro_trends_ngpl.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
check these results to the old data where I though most were significant

maybe its because before I did not remove duplicates???

Still salvageable because there are some scales where it is significant even if at a global scale it is not. Perhaps this angle actually plays to our advantage
