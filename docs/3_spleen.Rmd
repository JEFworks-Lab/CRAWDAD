...
ggplot2::ggsave(filename = "3_spleen_pkhl_tissue_legend.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
annots_temp <- crawdad::selectLabels(df = pkhl,
                                     ...
                                     cellIDs = c("CD4 Memory T cells", "Fol B cells"),
                                     subsetIDs = c("CD4 Memory T cells_near_Neutrophils/Monocytes", "CD4 Memory T cells_near_Fol B cells"))
...
ggplot2::ggsave(filename = "3_spleen_pkhl_cd4_subsets_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "3B_spleen_pkhl_grid_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "3_spleen_pkhl_cd4_trends_heatmap.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S11_spleen_ksfb_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S11_spleen_xxcd_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S11_spleen_pbvn_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S11_spleen_fsld_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S11_spleen_ngpl_tissue.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_trends_heatmap.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_ksfb_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_xxcd_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_pbvn_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_fsld_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_ngpl_cd4_folB_podo_trends.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_folB_trends_heatmap.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_neutro_trends_heatmap.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_neutro_trends_ksfb.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_folB_trends_xxcd.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_neutro_trends_xxcd.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_folB_trends_pbvn.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_neutro_trends_pbvn.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_folB_trends_fsld.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_neutro_trends_fsld.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_folB_trends_ngpl.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
...
ggplot2::ggsave(filename = "S12_spleen_cd4_near_neutro_trends_ngpl.pdf",
                plot = plt,
                device = "pdf",
                path = figpath,
                scale = 1,
